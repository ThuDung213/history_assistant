...
import { getPlaceDetail } from '../mock/placeApi';
import PlaceModal from './PlaceModal';


const INITIAL_CENTER = [
    108.21168309278522, 16.060197215687733
]
...
const DanangMap = () => {
    ...
    useEffect(() => {
        ...
        mapRef.current.on('load', () => {
            // Load icon marker
            mapRef.current.loadImage("/textures/vietnam-size48.png", (error, image) => {
                ...
                mapRef.current.addSource("danang-places", {
                    type: "geojson",
                    data: "/data/map_point/danang_places.geojson", // từ public/
                });
